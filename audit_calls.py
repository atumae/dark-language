...
args char_at chr dns env exec exists file_size keys kind listdir make_exe mkdir ord os push random
remove setenv size sleep slurp spit stop substring syscall system tcp_close tcp_connect tcp_recv
tcp_send time_now to_int to_string trim values
gcm_open_d gcm_seal_d hkdf_d hmac_d sha256_d x25519_d
gui_heading gui_label gui_mono gui_colored gui_button gui_separator gui_text gui_textarea gui_get
gui_set run_dark""".split())
